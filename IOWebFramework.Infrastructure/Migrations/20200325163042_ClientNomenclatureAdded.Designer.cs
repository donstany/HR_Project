...
namespace IOWebFramework.Infrastructure.Migrations
{
    ...
    [Migration("20200325163042_ClientNomenclatureAdded")]
    partial class ClientNomenclatureAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.Nomenclatures.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_nom_projects");

                    b.ToTable("nom_projects");
                });
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.ProjectDetail", b =>
                {
                    ...
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Nomenclatures.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_d_project_details_nom_projects_project_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
