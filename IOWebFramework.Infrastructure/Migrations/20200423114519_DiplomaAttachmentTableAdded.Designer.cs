...
namespace IOWebFramework.Infrastructure.Migrations
{
    ...
    [Migration("20200423114519_DiplomaAttachmentTableAdded")]
    partial class DiplomaAttachmentTableAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.AttachedDocument", b =>
                {
                    ...
                    b.HasIndex("AttachmentTypeId")
                        .HasName("ix_attached_documents_attachment_type_id");
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.Crew", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasIndex("PersonId")
                        .HasName("ix_d_crews_person_id");

                    b.HasIndex("ProjectRoleId")
                        .HasName("ix_d_crews_project_role_id");

                    b.HasIndex("ProjectId", "PersonId", "ProjectRoleId")
                        .IsUnique()
                        .HasName("ix_d_crews_project_id_person_id_project_role_id");
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "7e5a1cd4-7106-438a-9200-6f30a7831a84",
                            Name = "HR",
                            NormalizedName = "HR"
                        },
                        new
                        {
                            Id = "2",
                            ConcurrencyStamp = "0135bac7-066f-4874-b55d-cadd3a3fda5c",
                            Name = "Employee",
                        ...
                        {
                            Id = "3",
                            ConcurrencyStamp = "668c5ea8-457a-42cd-a848-0db3d0e2b704",
                            Name = "SuperAdmin",
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.Nomenclatures.AttachmentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.ProjectDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_d_project_details");

                    b.HasIndex("EmployeeId")
                        .HasName("ix_d_project_details_employee_id");

                    b.HasIndex("ProjectId")
                        .HasName("ix_d_project_details_project_id");

                    b.HasIndex("ProjectRoleId")
                        .HasName("ix_d_project_details_project_role_id");

                    b.HasIndex("TechnologyId")
                        .HasName("ix_d_project_details_technology_id");

                    b.ToTable("d_project_details");
                });
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.TechnologyProject", b =>
                {
                    ...
                    b.HasIndex("ProjectId")
                        .HasName("ix_d_technology_project_project_id");
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.AttachedDocument", b =>
                {
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Nomenclatures.AttachmentType", "AttachmentType")
                        .WithMany()
                        .HasForeignKey("AttachmentTypeId")
                        .HasConstraintName("fk_attached_documents_attachment_types_attachment_type_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.Crew", b =>
                {
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Person", "Person")
                        .WithMany("Crews")
                        .HasForeignKey("PersonId")
                        .HasConstraintName("fk_d_crews_d_persons_person_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Project", "Project")
                        ...
                        .HasConstraintName("fk_d_crews_d_projects_project_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Nomenclatures.ProjectRole", "ProjectRole")
                        ...
                        .HasConstraintName("fk_d_crews_nom_project_role_project_role_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.ProjectDetail", b =>
                {
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("fk_d_project_details_d_employees_employee_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_d_project_details_d_projects_project_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Nomenclatures.ProjectRole", "ProjectRole")
                        .WithMany()
                        .HasForeignKey("ProjectRoleId")
                        .HasConstraintName("fk_d_project_details_nom_project_role_project_role_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Nomenclatures.Technology", "Technology")
                        ...
                        .HasConstraintName("fk_d_project_details_nom_technologies_technology_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
