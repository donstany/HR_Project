...
namespace IOWebFramework.Infrastructure.Migrations
{
    ...
    [Migration("20200326075300_ProjectAddedAndProjectNomenclatureDeleted")]
    partial class ProjectAddedAndProjectNomenclatureDeleted
    {
            ...
            modelBuilder.Entity("IOWebFramework.Infrastructure.Data.Models.Project", b =>
                {
                    ...
                    b.HasOne("IOWebFramework.Infrastructure.Data.Models.Employee", "Employee")
                        ...
                        .HasConstraintName("fk_d_projects_d_employees_manager_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
